...
const NcModal: FC<NcModalProps> = ({
  ...
  return (
    <div className="nc-NcModal overflow-visible">
      {renderTrigger ? (
      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-1 text-center md:px-4">
            ...
            >
              <div
                className={`inline-block w-full my-5 overflow-visible text-left align-middle transition-all transform bg-white border border-black border-opacity-5 shadow-xl rounded-2xl sm:my-8 dark:bg-neutral-800 dark:border-neutral-700 text-neutral-900 dark:text-neutral-300 ${contentExtraClass}`}
              >
