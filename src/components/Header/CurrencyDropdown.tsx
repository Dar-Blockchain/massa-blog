          ...
          <>
            ...
            >
              ...
              <ChevronDownIcon
                ...
                } ms-2 h-4 w-4 text-neutral-700 dark:text-neutral-300 group-hover:text-opacity-80 transition ease-in-out duration-150`}
                aria-hidden="true"
              />
            </Popover.Button>
            <Transition
            ...
            >
              <Popover.Panel className={`absolute z-10 w-screen max-w-[140px] px-4 mt-4 sm:px-0 lg:max-w-[140px] ${panelClassName}`}>
